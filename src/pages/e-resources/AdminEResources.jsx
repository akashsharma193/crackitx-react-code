...
import { Plus, FileText, Link, Trash2, ChevronDown, Download } from 'lucide-react';
...
const AdminEResources = () => {
    ...
    const handleDelete = async (resourceId) => {
        if (window.confirm('Are you sure you want to delete this resource?')) {
            try {
                await apiClient.delete(`/ereources/delete/${resourceId}`);
            ...
            <div className="!px-6">
                {loading ? (
                    ...
                    <div className="bg-white rounded-xl shadow-md !p-8 text-center">
                        ...
                        <p className="text-gray-500">Click "Add Resource" to upload your first resource</p>
                    </div>
                ) : (
                    <>
