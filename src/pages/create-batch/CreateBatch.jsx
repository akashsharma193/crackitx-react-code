...
const CreateBatch = () => {
  ...
  const fetchBatches = async () => {
    ...
    try {
      ...
      console.log("Batches Received:", response.data?.data);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("Create Batch Data:", response.data);
        ...
        <div className="flex-1 bg-gray-50 overflow-y-auto">
          ...
          <div className="flex justify-center items-center w-full !px-4 !py-6">
            <div className="w-full max-w-6xl space-y-6">
              <form className="bg-white border border-[#d9d9f3] rounded-xl shadow-md !px-8 !py-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 !mb-6">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full border rounded-md !px-4 !py-2 !h-[42px] outline-none focus:ring-2 focus:ring-opacity-50 ${
                        errors.name
                  ...
                  <div className="md:col-span-2">
                    ...
                    <textarea
                      ...
                      onChange={handleInputChange}
                      className={`w-full border rounded-md !px-4 !py-2 outline-none focus:ring-2 focus:ring-opacity-50 resize-none ${
                        errors.description
                          ? "border-red-500 focus:ring-red-500"
                          : "border-[#7966F1] focus:ring-[#7966F1]"
                      }`}
                ...
                <div className="flex justify-center">
                  <button
                    ...
                    disabled={loading}
                    className={`bg-gradient-to-r from-[#7966F1] to-[#9F85FF] text-white font-semibold !px-10 !py-3 rounded-full shadow-md transition-all cursor-pointer ${
                      loading
