            ...
            >
                ...
                <div>
                  ...
                  <div className="relative" ref={batchDropdownRef}>
                    <input
                      ...
                      disabled={
                        loading || isLoadingBatches || !formData.orgCode
                      }
                      className={`w-full border rounded-md !px-4 !py-2 !pr-10 !h-[42px] outline-none focus:ring-1 focus:ring-opacity-50 ${
                        errors.batchCode
                          ? "border-red-500 focus:ring-red-500"
              ...
              <div className="flex justify-center">
                <button
                  type="submit"
                  disabled={loading}
                  className={`bg-gradient-to-r from-[#7966F1] to-[#9F85FF] text-white font-semibold !px-10 !py-3 rounded-lg shadow-md transition-all cursor-pointer flex items-center gap-2 ${
                    loading
