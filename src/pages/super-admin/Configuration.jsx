                ...
                <div className="space-y-6">
                  <div className="bg-gray-50 rounded-lg !p-6">
                    ...
                    <select
                      ...
                      className="w-full text-sm text-gray-700 border border-gray-400 rounded-md !px-4 !py-2 !h-[42px] outline-none focus:ring-1 focus:ring-[#7966F1] focus:ring-opacity-50"
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-xs text-gray-500 !mt-1">
                              Prevent users from accessing internet during exam
                              sessions
                            </p>
                          </div>
                          <label className="relative inline-flex items-center cursor-pointer">
                            <input
                              ...
                              onChange={handleInputChange}
                              disabled={
                                loading || (currentConfig && !isEditing)
                              }
                ...
                <div className="bg-white border border-[#d9d9f3] rounded-xl shadow-md !px-8 !py-6 !mt-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex items-center justify-between !p-3 bg-gray-50 rounded-lg">
                      ...
                      <span className="text-sm font-semibold text-[#7966F1]">
                        {currentConfig.activationMode.replace("_", " ")}
                      </span>
                    </div>
                    <div className="flex items-center justify-between !p-3 bg-gray-50 rounded-lg">
                      <span className="text-sm text-gray-700">
                      ...
                      <span
                        className={`text-sm font-semibold ${currentConfig.isInternetDisabled ? "text-green-600" : "text-red-600"}`}
                      >
                    ...
                    <div className="flex items-center justify-between !p-3 bg-gray-50 rounded-lg">
                      ...
                      <span
                        className={`text-sm font-semibold ${currentConfig.isTabSwitchDisabled ? "text-green-600" : "text-red-600"}`}
                      >
                    ...
                    <div className="flex items-center justify-between !p-3 bg-gray-50 rounded-lg">
                      ...
                      <span
                        className={`text-sm font-semibold ${currentConfig.multipleLoginAllowed ? "text-green-600" : "text-red-600"}`}
                      >
                        {currentConfig.multipleLoginAllowed
                          ? "Allowed"
                          : "Not Allowed"}
                      </span>
                    </div>
