                ...
                <div>
                  ...
                  <div className="flex gap-2 items-center">
                    <input
                      ...
                      value="+91"
                      disabled
                      className="w-[50px] border border-gray-400 rounded-md !px-2 !py-2 !h-[42px] text-gray-700 bg-gray-100 cursor-not-allowed"
                      placeholder="+91"
                    />
                    <input
                      type="tel"
                      ...
                      onChange={handleInputChange}
                      className={`flex-1 border rounded-md !px-4 !py-2 !h-[42px] outline-none focus:ring-1 focus:ring-opacity-50 ${
                        errors.mobile
                          ? "border-red-500 focus:ring-red-500"
                          : "border-gray-400 focus:ring-[#7966F1]"
                      }`}
                ...
                <div>
                  ...
                  <div className="relative" ref={orgDropdownRef}>
                    <input
                      ...
                      className={`w-full border rounded-md !px-4 !py-2 !pr-10 !h-[42px] outline-none focus:ring-1 focus:ring-opacity-50 ${
                        errors.orgCode
                          ? "border-red-500 focus:ring-red-500"
                          : "border-gray-400 focus:ring-[#7966F1]"
                      }`}
                    ...
                    <div
                      ...
                      style={{ paddingRight: "12px", pointerEvents: "none" }}
                    >
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full border rounded-md !px-4 !py-2 !pr-12 !h-[42px] outline-none focus:ring-1 focus:ring-opacity-50 ${
                        errors.password
                          ? "border-red-500 focus:ring-red-500"
                          : "border-gray-400 focus:ring-[#7966F1]"
                      }`}
