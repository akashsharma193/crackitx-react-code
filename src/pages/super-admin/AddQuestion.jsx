...
import { Plus, X, ImageIcon, Type, ChevronDown } from "lucide-react";
  ...
  const validateForm = () => {
    ...
    if (optionsInputMode === "both") {
      ...
      if (!hasTextOptions && !hasImageOptions) {
        newErrors.options =
          "At least text or images for all options are required";
      }
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await apiClient.post(
        "/questionGenerator/createQuestionList",
        [questionData],
      );
    ...
    return (
      <div ref={ref} className="relative w-full">
        ...
        <button
          ...
          className={`w-full flex items-center justify-between !px-4 !py-3 text-sm rounded-lg border bg-white focus:outline-none focus:ring-1 ${
            error
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="bg-gradient-to-r from-[#7966F1] to-[#9F85FF] !px-6 !py-4">
        <h1 className="text-white text-lg  font-medium uppercase">
          Add Question
        </h1>
      </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 !p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 !mb-6">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full !px-4 !py-3 text-gray-700 text-sm border rounded-lg focus:outline-none focus:ring-1 focus:ring-opacity-50 ${errors.language ? "border-red-500 focus:ring-red-500" : "border-gray-400 focus:ring-[#5E48EF]"}`}
            ...
            <div className="flex items-center justify-between !mb-2">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`flex items-center gap-1 !px-3 !py-1 border border-gray-400 rounded-md text-sm transition cursor-pointer ${questionInputMode === "text" ? "bg-[#5E48EF] text-white" : "bg-gray-100 text-gray-600"}`}
                >
                ...
                <button
                  ...
                  className={`flex items-center gap-1 !px-3 !py-1 border border-gray-400 rounded-md text-sm transition cursor-pointer ${questionInputMode === "image" ? "bg-[#5E48EF] text-white" : "bg-gray-100 text-gray-600"}`}
                >
                ...
                <button
                  ...
                  className={`flex items-center gap-1 !px-3 !py-1 border border-gray-400 rounded-md text-sm transition cursor-pointer ${questionInputMode === "both" ? "bg-[#5E48EF] text-white" : "bg-gray-100 text-gray-600"}`}
                >
                  <Type className="w-4 h-4" />
                  <ImageIcon className="w-4 h-4" />
                  Both
              ...
              {(questionInputMode === "text" ||
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={`w-full !px-4 !py-3 text-gray-700 text-sm border rounded-lg focus:outline-none focus:ring-1 focus:ring-opacity-50 resize-none ${errors.question ? "border-red-500 focus:ring-red-500" : "border-gray-400 focus:ring-[#5E48EF] "}`}
                  ...
                  {questionImage ? (
                    <div className="relative">
                      <img
                        src={questionImage}
                        alt="Question"
                        className="w-full max-h-64 object-contain border border-gray-400 rounded-lg"
                      />
                      <button
                        type="button"
                    ...
                    <button
                      ...
                      className="w-full !px-4 !py-8 text-gray-700 text-sm border-2 border-dashed border-gray-400 rounded-lg hover: transition cursor-pointer flex flex-col items-center gap-2"
                    >
            ...
            <div className="flex items-center justify-between !mb-3">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`flex items-center gap-1 !px-3 !py-1 border border-gray-400 rounded-md text-sm transition cursor-pointer ${optionsInputMode === "text" ? "bg-[#5E48EF] text-white" : "bg-gray-100 text-gray-600"}`}
                >
                  <Type className="w-4 h-4" />
                  Text Only
                </button>
                <button
                  ...
                  className={`flex items-center gap-1 !px-3 !py-1 border border-gray-400 rounded-md text-sm transition cursor-pointer ${optionsInputMode === "image" ? "bg-[#5E48EF] text-white" : "bg-gray-100 text-gray-600"}`}
                >
                  <ImageIcon className="w-4 h-4" />
                  Image Only
                </button>
                <button
                  ...
                  className={`flex items-center gap-1 !px-3 !py-1 border border-gray-400 rounded-md text-sm transition cursor-pointer ${optionsInputMode === "both" ? "bg-[#5E48EF] text-white" : "bg-gray-100 text-gray-600"}`}
                >
                  <Type className="w-4 h-4" />
                  <ImageIcon className="w-4 h-4" />
                  Both
              ...
              {options.map((option, index) => (
                <div key={index} className="flex items-start gap-3">
                  <button
                    ...
                    className={`w-6 h-6 rounded border-2 flex-shrink-0 transition-all cursor-pointer flex items-center justify-center !mt-1 ${formData.correctAnswer === index ? "border-gray-400 bg-[#5E48EF]" : "border-gray-400 bg-transparent"}`}
                  >
                  ...
                  <div className="flex-1">
                    ...
                    {(optionsInputMode === "text" ||
                      ...
                      <input
                        ...
                        className="w-full !px-4 !py-3 !mt-2 text-gray-700 text-sm border border-gray-400 rounded-lg focus:outline-none focus:ring-1 focus:ring-[#5E48EF] "
                        ...
                        {optionImages[index] ? (
                          <div className="relative">
                            <img
                              ...
                              alt={`Option ${index + 1}`}
                              className="w-full max-h-32 object-contain border border-gray-400 rounded-lg"
                            />
                            <button
                              type="button"
                              onClick={() => {
                          ...
                          <button
                            ...
                            className="w-full !px-4 !py-6 text-gray-700 text-sm border-2 border-dashed border-gray-400 rounded-lg hover: transition cursor-pointer flex flex-col items-center gap-1"
                          >
          ...
          <div className="flex justify-center">
            <button
              ...
              disabled={loading}
              className={`bg-gradient-to-r from-[#7966F1] to-[#9F85FF] text-white font-semibold !px-12 !py-3 rounded-lg shadow-md transition-all cursor-pointer ${loading ? "opacity-50 cursor-not-allowed" : "hover:opacity-90"}`}
            >
