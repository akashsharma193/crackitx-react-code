          ...
          <div className="flex justify-center items-center w-full !px-4 !py-6">
            <div className="w-full max-w-6xl space-y-6">
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 !mb-6">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full border rounded-md !px-4 !py-2 !h-[42px] outline-none focus:ring-1 focus:ring-opacity-50 ${
                        errors.name
                          ? "border-red-500 focus:ring-red-500"
                          : "border-gray-400 focus:ring-[#7966F1]"
                      }`}
                  ...
                  <div className="md:col-span-2">
                    ...
                    <textarea
                      ...
                      onChange={handleInputChange}
                      className={`w-full border rounded-md !px-4 !py-2 outline-none focus:ring-1 focus:ring-opacity-50 resize-none ${
                        errors.description
                          ? "border-red-500 focus:ring-red-500"
                          : "border-gray-400 focus:ring-[#7966F1]"
                      }`}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 !mb-6">
                  <div className="flex items-center justify-between border border-gray-400 rounded-md !px-4 !py-3">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                        formData.examHistory ? "bg-[#7966F1]" : "bg-gray-300"
                      } ${loading ? "opacity-50 cursor-not-allowed" : "cursor-pointer"}`}
                    >
                      <span
                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                          formData.examHistory
                            ? "translate-x-6"
                            : "translate-x-1"
                        }`}
                      />
                  ...
                  <div className="flex items-center justify-between border border-gray-400 rounded-md !px-4 !py-3">
                    ...
                    <button
                      ...
                      disabled={loading}
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                        formData.examStrat ? "bg-[#7966F1]" : "bg-gray-300"
                      } ${loading ? "opacity-50 cursor-not-allowed" : "cursor-pointer"}`}
                    >
                      <span
                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                          formData.examStrat ? "translate-x-6" : "translate-x-1"
                        }`}
                      />
                    </button>
                  </div>
                  ...
                  <div className="flex items-center justify-between border border-gray-400 rounded-md !px-4 !py-3">
                    ...
                    <button
                      ...
                      disabled={loading}
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                        formData.examComplete ? "bg-[#7966F1]" : "bg-gray-300"
                      } ${loading ? "opacity-50 cursor-not-allowed" : "cursor-pointer"}`}
                    >
                      <span
                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                          formData.examComplete
                            ? "translate-x-6"
                            : "translate-x-1"
                        }`}
                      />
                    ...
                    <table className="w-full border-collapse">
                      <thead>
                        <tr className="border-b border-gray-400">
                          <th className="text-left !px-4 !py-3 text-sm font-semibold text-gray-700 border-r border-gray-400">
                            Name
                          </th>
                          <th className="text-left !px-4 !py-3 text-sm font-semibold text-gray-700 border-r border-gray-400">
                            Description
                      ...
                      <tbody>
                        {organizations.map((org) => (
                          ...
                          >
                            <td className="!px-4 !py-3 text-sm text-gray-800 border-r border-gray-400">
                              {org.name}
                            </td>
                            <td className="!px-4 !py-3 text-sm text-gray-600 border-r border-gray-400">
                              {org.description}
                            </td>
