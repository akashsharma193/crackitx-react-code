...
const CreateSubject = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const endpoint = editingSubject ? '/subject/update' : '/subject/create';
                    ...
                    <div className="flex justify-center items-center w-full !px-4 !py-6">
                        <div className="w-full max-w-6xl space-y-6">
                            <div className="bg-white border border-[#d9d9f3] rounded-xl shadow-md !px-8 !py-10">
                                <h3 className="text-xl font-semibold text-gray-800 !mb-6">Subject Information</h3>
                            ...
                            <div className="bg-white border border-[#d9d9f3] rounded-xl shadow-md !px-8 !py-10 !mt-4">
                                <h3 className="text-xl font-semibold text-gray-800 !mb-6">Existing Subjects</h3>
                                                    ...
                                                    {subjects.map((subject) => (
                                                        <tr key={subject.id} className="border-b border-gray-100 hover:bg-gray-50">
                                                            ...
                                                            <td className="!px-4 !py-3">
                                                                <span className={`text-xs font-medium !px-2 !py-1 rounded-full ${subject.isActive
                                        ...
                                        {pagination.totalPages > 1 && (
                                            <div className="flex items-center justify-between !mt-6">
                                                <div className="text-sm text-gray-600">
                                                    Showing {pagination.pageNumber * pagination.pageSize + 1} to {Math.min((pagination.pageNumber + 1) * pagination.pageSize, pagination.totalElements)} of {pagination.totalElements} subjects
                                                </div>
